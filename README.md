...
Sudoku-Solver is a small Python project that extracts digits from Sudoku puzzle images and solves the puzzle while including a feature to extract text from an image.
...
- A CLI argument for extracting text from an image.
